...
CREATE TABLE IF NOT EXISTS `repository_jti`.`document` (
  ...
  INDEX `fk_document_user_idx` (`id_user` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `repository_jti`.`mentioned_user` (
  ...
  INDEX `fk_mentioned_user_document1_idx` (`id_document` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `repository_jti`.`view` (
  ...
  `id_user` VARCHAR(15) NOT NULL,
  `id_document` VARCHAR(10) NOT NULL,
  INDEX `fk_view_user1_idx` (`id_user` ASC) VISIBLE,
  INDEX `fk_view_document1_idx` (`id_document` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `repository_jti`.`download` (
  ...
  `id_document` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`id_user`, `id_document`),
  INDEX `fk_download_document1_idx` (`id_document` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `repository_jti`.`trakcing_doc` (
  ...
  INDEX `fk_trakcing_doc_user1_idx` (`id_user` ASC) VISIBLE,
  INDEX `fk_trakcing_doc_document1_idx` (`id_document` ASC) VISIBLE,
